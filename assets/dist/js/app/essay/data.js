    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
            console.log(data);
          return `<div class="text-center">
                                <a href="${base_url}soalessay/detail/${data}" class="btn btn-xs btn-default">
                                    <i class="fa fa-eye"></i> Detail
                                </a>
                                <a href="${base_url}soalessay/edit/${data}" class="btn btn-xs btn-warning">
