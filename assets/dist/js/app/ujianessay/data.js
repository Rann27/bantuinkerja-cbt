...
$(document).ready(function () {
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    return `<div class="text-center">
									...
									<a href="${base_url}ujianessay/edit/${data}" class="btn btn-xs btn-warning">
    ...
    $('#ujian').on('click', '.btn-token', function () {
        ...
        $.ajax({
            url: base_url+'ujianessay/refresh_token/' + id,
            type: 'get',
            dataType: 'json',
    ...
    table.ajax.url(base_url+'ujianessay/json/'+id_dosen).load();
});
