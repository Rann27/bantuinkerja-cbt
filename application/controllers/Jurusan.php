...
class Jurusan extends CI_Controller
{
	...
	public function __construct()
	{
		...
		else if ($this->ion_auth->is_admin() && $this->ion_auth->in_group('spp')) {
	...
	public function index()
	{
		$data = [
			...
			'subjudul' => 'Data Program Keahlian'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Program Keahlian',
			'subjudul'	=> 'Tambah Data Program Keahlian',
	...
	public function edit()
	{
		...
		if (!$chk) {
			...
			$data = [
				'user' 		=> $this->ion_auth->user()->row(),
				'judul'		=> 'Edit Program Keahlian',
				'subjudul'	=> 'Edit Program Keahlian',
				'jurusan'	=> $jurusan
			];
			$this->load->view('_templates/dashboard/_header', $data);
	...
	public function jurusan_by_kelas($kelas)
	{
		$data = $this->master->getJurusanByKelas($kelas);
		$this->output_json($data);
	}
	...
	public function import($import_data = null)
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> 'Program Keahlian',
			'subjudul' => 'Import Program Keahlian'
		];
