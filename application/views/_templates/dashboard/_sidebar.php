	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<?php if ($this->ion_auth->is_admin() || $this->ion_auth->in_group('dosen')) : ?>
				<li class="<?= $page === 'soal' ? "active" : "" ?>">
					<a href="<?= base_url('soal') ?>" rel="noopener noreferrer">
						<i class="fa fa-file-text-o"></i> <span>Soal Pilgan</span>
					</a>
				</li>
				<li class="<?= $page === 'soalessay' ? "active" : "" ?>">
					<a href="<?= base_url('soalessay') ?>" rel="noopener noreferrer">
			...
			<?php if ($this->ion_auth->in_group('dosen')) : ?>
				...
				<li class="<?= $page === 'ujianessay' ? "active" : "" ?> d-none">
					<a href="<?= base_url('ujianessay/master') ?>" rel="noopener noreferrer">
						<i class="fa fa-th"></i> <span>Ujian Essay</span>
					</a>
				</li>
			<?php endif; ?>
			<?php if ($this->ion_auth->in_group('mahasiswa')) : ?>
				...
				<li class="<?= $page === 'ujianessay' ? "active" : "" ?> d-none">
					<a href="<?= base_url('ujianessay/list') ?>" rel="noopener noreferrer">
						<i class="fa fa-th"></i> <span>Ujian Essay</span>
					</a>
				</li>
			<?php endif; ?>
			<?php if ($this->ion_auth->in_group('dosen') || $this->ion_auth->is_admin()) : ?>
			...
			<?php endif; ?>
			<?php if ($this->ion_auth->in_group('spp')) : ?>
				<li class="<?= $page === 'users' ? "active" : "" ?>">
					<a href="<?= base_url('users/listsiswa') ?>">
