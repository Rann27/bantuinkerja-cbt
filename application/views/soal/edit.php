                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-9">
                                        <textarea name="soal" id="soal" class="form-control ckeditor"><?=$soal->soal?></textarea>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <input required="required" value="<?=$soal->bobot?>" type="number" step="0.01" name="bobot" placeholder="Bobot Soal" id="bobot" class="form-control">
