<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?= form_open('ujianessay/save', array('id' => 'formujian'), array('method' => 'add', 'dosen_id' => $dosen->id_dosen, 'matkul_id' => $matkul->matkul_id)) ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/ujianessay/add.js"></script>