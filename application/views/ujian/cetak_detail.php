...
$html .= <<<EOD
    <tr>
        ...
        <td align="center" width="15%">{$row->nim}</td>
        <td width="35%">{$row->nama}</td>
        <td align="center" width="10%">{$row->nama_kelas}</td>
        <td align="center" width="15%">{$row->nama_jurusan}</td>
        <td align="center" width="10%">{$row->jml_benar}</td>
        <td align="center" width="10%">{$row->nilai}</td>
    </tr>
EOD;
$no++;
}
...
$pdf->Output('Hasil Ujian '.$ujian->nama_ujian.'.pdf', 'I');
