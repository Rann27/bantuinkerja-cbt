    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="status_essay">Soal Essay</label>
                    <select name="status_essay" class="form-control">
                        <option value="" disabled selected>--- Status Soal Essay ---</option>
                        <option <?=$ujian->status_essay==="0"?"selected":"";?> value="0">NonAktif</option>
                        <option <?=$ujian->status_essay==="1"?"selected":"";?> value="1">Aktif</option>
                    </select>
                    <small class="help-block"></small>
                </div>
				<div class="form-group">
                    <label for="status_curang">Fitur Anti Curang</label>
                    <select name="status_curang" class="form-control">
                        <option value="" disabled selected>--- Status Anti Curang ---</option>
                        <option <?=$ujian->status_curang==="0"?"selected":"";?> value="0">NonAktif</option>
                        <option <?=$ujian->status_curang==="1"?"selected":"";?> value="1">Aktif</option>
                    </select>
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    ...
                    <select name="status_ujian" class="form-control">
                        <option value="" disabled selected>--- Status Ujian ---</option>
                        <option <?=$ujian->status_ujian==="0"?"selected":"";?> value="0">NonAktif</option>
                        <option <?=$ujian->status_ujian==="1"?"selected":"";?> value="1">Aktif</option>
                    </select>
                    <small class="help-block"></small>
                </div>
