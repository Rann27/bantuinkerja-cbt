        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="pull-right">
                    <a href="<?= base_url('soalessay/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
                    <a href="<?= base_url('soalessay/add') ?>" class="btn bg-purple btn-flat btn-sm"><i class="fa fa-plus"></i> Buat Soal</a>
                    <button type="button" onclick="reload_ajax()" class="btn btn-flat btn-sm bg-maroon"><i class="fa fa-refresh"></i> Reload</button>
                </div>
            </div>
        </div>
    </div>
    <?= form_open('soalessay/delete', array('id' => 'bulk')) ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#matkul_filter').on('change', function() {
                ...
                let src = '<?= base_url() ?>soalessay/data';
                let url;
